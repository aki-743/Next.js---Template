...
const DefaultDialog = forwardRef<HTMLDivElement, PropsWithChildren<FormDialogProps>>(function render(
  { children, id, className, open, fullWidth = true, title, dialogText, buttonSize, buttonLoading, onClose, onSubmit },
  ref,
) {
  return (
    <Dialog id={id} className={classNames(styles.root, className)} ref={ref} open={open} fullWidth={fullWidth} onClose={onClose}>
